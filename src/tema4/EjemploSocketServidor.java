...
public class EjemploSocketServidor {
	...
	public static void main(String[] args) {
		...
		Logger logConsola = (Logger) LoggerFactory.getLogger("ConsolaSocket");

		try {
			// Aranco el servidor en el puerto 12345
			servSock = new ServerSocket(12345);

			// Espero a que un cliente se conecte
			sockCliente = servSock.accept();

			logConsola.info("INFO: Se ha conectado el cliente con ip xxx");
			...
			if (msg.contains("solicitando")) {
				...
				don.writeUTF("Bienvenido a la base, su plataforme de aterrizaje es: ");
