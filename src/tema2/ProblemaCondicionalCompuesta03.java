	...
	public static void main(String[] args) {
		...
		//Se definen las variables del primero, segundo, tercer numero
				...
				if ((num1<10)&&(num2<10)&&(num3<10)){
					...
					//Se imrpime en pantalla el mensaje indicando que todos los número son menores de 10
					System.out.println("Todos los números son menores de 10");
					
				}//if
				else {
					//Se imrpime en pantalla el mensaje indicando que todos los número son mayores de 10
					System.out.println("Algunos números son mayores de 10");
				}
