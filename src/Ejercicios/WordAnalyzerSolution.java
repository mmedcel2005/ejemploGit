...
public class WordAnalyzerSolution {

	// Cadena de caracteres que se va a tratar.
	private String word;

	/**
	 * Construye un analizador para una palabra determinada.
	 * 
	 * @param aWord la palabra que se va a analizar (no nula)
	 */
	public WordAnalyzerSolution(String aWord) {
		assert aWord != null;
		word = aWord;
	}
